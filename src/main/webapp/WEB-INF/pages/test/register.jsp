    ...
    <div id = "content">
        <div id = "form">
            ...
            <form action="register.action" method="post" id="myform" onsubmit="return validate()">
                ...
                <br/>
                密码<input type="password" id="password" name="Password" style="width:190px; height: 26px; margin-top: 8px; margin-left: 54px">
                <br/>
                姓名<input type="text" id="name" name="name" style="width:190px; height: 260px; margin-top: 8px; margin-left: 54px;">
                <br/>
                手机号<input type="submit" value="注册" style="width: 50px; height: 30px; margin-top: 8px;/">
                <a href="toLogin.action">返回登录</a>
            </form>

            <!--显示错误信息-->
            <c:if test="${errorMsg != null}">
                <span class=".span">${errorMsg}</span>
            </c:if>
        </div>
    </div>
</body>
